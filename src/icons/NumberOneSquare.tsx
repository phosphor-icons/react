...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <polyline points="108.009 95.992 131.991 80 131.991 175.994" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <polyline points="108.009 95.992 131.991 80 131.991 175.994" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  ...
  <path d="M208,32H48A16.02085,16.02085,0,0,0,32,48V208a16.02085,16.02085,0,0,0,16,16H208a16.02085,16.02085,0,0,0,16-16V48A16.02085,16.02085,0,0,0,208,32ZM139.99219,175.99219a8,8,0,0,1-16,0V94.95313l-11.54688,7.69531a7.99982,7.99982,0,1,1-8.875-13.3125l23.98438-15.99219A7.99941,7.99941,0,0,1,139.99219,80Z"/>
    ...
    case "light":
      return (<>
  <rect width="256" height="256" fill="none"/>
  <polyline points="108.009 95.992 131.991 80 131.991 175.994" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  <rect x="40" y="40" width="176" height="176" rx="8" strokeWidth="12" stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    ...
    case "thin":
      return (<>
  <rect width="256" height="256" fill="none"/>
  <polyline points="108.009 95.992 131.991 80 131.991 175.994" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
...
const NumberOneSquare = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
...
NumberOneSquare.displayName = "NumberOneSquare";

export default NumberOneSquare;
