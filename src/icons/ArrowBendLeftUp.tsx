...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <path d="M200,224a96,96,0,0,1-96-96V32" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <path d="M200,224a96,96,0,0,1-96-96V32" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>

</>)
    case "thin":
      return (<>
  <polyline points="152 80 104 32 56 80" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <path d="M200,224a96,96,0,0,1-96-96V32" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
