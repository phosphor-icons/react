...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <path d="M200,32a96,96,0,0,0-96,96v96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <path d="M200,32a96,96,0,0,0-96,96v96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>

</>)
    case "thin":
      return (<>
  <polyline points="152 176 104 224 56 176" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <path d="M200,32a96,96,0,0,0-96,96v96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
