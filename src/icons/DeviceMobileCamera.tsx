...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <rect x="16" y="64" width="224" height="128" rx="16" transform="translate(256) rotate(90)" strokeWidth="16" stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    ...
    case "fill":
      return (<>
  <rect width="256" height="256" fill="none"/>
  <path d="M176,8H80A24.0275,24.0275,0,0,0,56,32V224a24.0275,24.0275,0,0,0,24,24h96a24.0275,24.0275,0,0,0,24-24V32A24.0275,24.0275,0,0,0,176,8ZM128,64a12,12,0,1,1,12-12A12,12,0,0,1,128,64Z"/>
