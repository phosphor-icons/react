...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <g fill="none" fillRule="evenodd">
    <polygon points="0 16 16 16 16 0 0 0"/>
    <path fill={color} d="M2,8 C2,4.687 4.687,2 8,2 C11.313,2 14,4.687 14,8 C14,11.313 11.313,14 8,14 C4.687,14 2,11.313 2,8" opacity=".2"/>
    <path fill={color} fillRule="nonzero" d="M8,1.5 C11.5891424,1.5 14.5,4.41085763 14.5,8 C14.5,11.5891424 11.5891424,14.5 8,14.5 C4.41085763,14.5 1.5,11.5891424 1.5,8 C1.5,4.41085763 4.41085763,1.5 8,1.5 Z M8,2.5 C4.96314237,2.5 2.5,4.96314237 2.5,8 C2.5,11.0368576 4.96314237,13.5 8,13.5 C11.0368576,13.5 13.5,11.0368576 13.5,8 C13.5,4.96314237 11.0368576,2.5 8,2.5 Z M10.5,7.5 C10.7761424,7.5 11,7.72385763 11,8 C11,8.24545989 10.8231248,8.44960837 10.5898756,8.49194433 L10.5,8.5 L5.5,8.5 C5.22385763,8.5 5,8.27614237 5,8 C5,7.75454011 5.17687516,7.55039163 5.41012437,7.50805567 L5.5,7.5 L10.5,7.5 Z"/>
  </g>
  ...
  <g fill="none" fillRule="evenodd">
    <polygon points="0 16 16 16 16 0 0 0"/>
    <path fill={color} d="M10.5,8.5 L5.5,8.5 C5.224,8.5 5,8.276 5,8 C5,7.724 5.224,7.5 5.5,7.5 L10.5,7.5 C10.776,7.5 11,7.724 11,8 C11,8.276 10.776,8.5 10.5,8.5 M8,1.5 C4.416,1.5 1.5,4.416 1.5,8 C1.5,11.584 4.416,14.5 8,14.5 C11.584,14.5 14.5,11.584 14.5,8 C14.5,4.416 11.584,1.5 8,1.5"/>
  </g>
