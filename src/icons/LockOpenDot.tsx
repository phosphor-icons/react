...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <circle cx="127.99414" cy="152" r="18"/>
  <path d="M92,88V52a36,36,0,0,1,72,0" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <path d="M92,88V52a36,36,0,0,1,72,0" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  ...
  <path d="M92,88V52a36,36,0,0,1,72,0" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
...
const LockOpenDot = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
...
LockOpenDot.displayName = "LockOpenDot";

export default LockOpenDot;
