...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <polyline points="120 120 128 120 128 176 136 176" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <polyline points="120 120 128 120 128 176 136 176" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  ...
  <polyline points="120 120 128 120 128 176 136 176" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
...
const InfoCircle = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
