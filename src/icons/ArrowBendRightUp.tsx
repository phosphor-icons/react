...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <path d="M56,224a96,96,0,0,0,96-96V32" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <path d="M56,224a96,96,0,0,0,96-96V32" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>

</>)
    case "thin":
      return (<>
  <polyline points="104 80 152 32 200 80" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <path d="M56,224a96,96,0,0,0,96-96V32" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
