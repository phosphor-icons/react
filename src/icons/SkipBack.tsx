...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <polygon points="108 128 156 96 156 160 108 128" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <line x1="100" y1="96" x2="100" y2="160" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <polygon points="108 128 156 96 156 160 108 128" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  ...
  <polygon points="108 128 156 96 156 160 108 128" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  <line x1="100" y1="96" x2="100" y2="160" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>

</>)
    case "thin":
      return (<>
  <circle cx="128" cy="128" r="96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <polygon points="108 128 156 96 156 160 108 128" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <line x1="100" y1="96" x2="100" y2="160" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
