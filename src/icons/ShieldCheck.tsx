...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <polyline points="172 96 113.333 152 84 124" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <polyline points="172 96 113.333 152 84 124" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  ...
  <polyline points="172 96 113.333 152 84 124" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
...
const ShieldCheck = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
