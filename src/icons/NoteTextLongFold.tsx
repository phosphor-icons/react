...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <line x1="96" y1="160" x2="128" y2="160" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <polyline points="215.277 159.992 160 159.992 160 215.272" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <polyline points="215.28 159.992 160 159.992 160 215.275" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  ...
  <line x1="96" y1="160" x2="128" y2="160" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  ...
  <polyline points="215.277 159.992 160 159.992 160 215.272" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  ...
  <line x1="96" y1="160" x2="128" y2="160" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  ...
  <polyline points="215.277 159.992 160 159.992 160 215.272" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
...
const NoteTextLongFold = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
...
NoteTextLongFold.displayName = "NoteTextLongFold";

export default NoteTextLongFold;
