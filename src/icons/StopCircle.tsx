...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <rect x="100" y="100" width="56" height="56" strokeWidth="24" stroke={color} strokeLinecap="round" strokeLinejoin="round"/>
  ...
  <rect x="100" y="100" width="56" height="56" strokeWidth="16" stroke={color} strokeLinecap="round" strokeLinejoin="round"/>
  ...
  <rect x="100" y="100" width="56" height="56" strokeWidth="12" stroke={color} strokeLinecap="round" strokeLinejoin="round"/>

</>)
    case "thin":
      return (<>
  <circle cx="128" cy="128" r="96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <rect x="100" y="100" width="56" height="56" strokeWidth="8" stroke={color} strokeLinecap="round" strokeLinejoin="round"/>
...
const StopCircle = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
