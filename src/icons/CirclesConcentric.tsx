...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <ellipse cx="128" cy="128" rx="48" ry="49" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <ellipse cx="128" cy="128" rx="48" ry="49" fill="none" stroke={color} strokeMiterlimit="10" strokeWidth="16"/>
  ...
  <ellipse cx="128" cy="128" rx="48" ry="49" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  ...
  <ellipse cx="128" cy="128" rx="48" ry="49" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
...
const CirclesConcentric = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
