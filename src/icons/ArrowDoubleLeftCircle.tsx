...
const ArrowDoubleLeftCircle = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
...
ArrowDoubleLeftCircle.displayName = "ArrowDoubleLeftCircle";

export default ArrowDoubleLeftCircle;
