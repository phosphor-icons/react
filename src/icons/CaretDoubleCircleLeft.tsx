...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <polyline points="168 160 136 128 168 96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <polyline points="112 160 80 128 112 96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <polyline points="168 160 136 128 168 96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  <polyline points="112 160 80 128 112 96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  ...
  <polyline points="168 160 136 128 168 96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <polyline points="112 160 80 128 112 96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
...
const CaretDoubleCircleLeft = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
...
CaretDoubleCircleLeft.displayName = "CaretDoubleCircleLeft";

export default CaretDoubleCircleLeft;
