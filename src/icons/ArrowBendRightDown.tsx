...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <path d="M56,32a96,96,0,0,1,96,96v96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <path d="M56,32a96,96,0,0,1,96,96v96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>

</>)
    case "thin":
      return (<>
  <polyline points="104 176 152 224 200 176" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <path d="M56,32a96,96,0,0,1,96,96v96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
