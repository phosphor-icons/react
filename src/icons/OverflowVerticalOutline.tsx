...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <circle cx="128" cy="48" r="24" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <circle cx="128" cy="208" r="24" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
...
const OverflowVerticalOutline = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
...
OverflowVerticalOutline.displayName = "OverflowVerticalOutline";

export default OverflowVerticalOutline;
