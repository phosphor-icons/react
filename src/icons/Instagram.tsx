...
const renderPathFor = (weight: string, color: string): JSX.Element | null => {
  ...
  <rect x="36" y="36" width="184" height="184" rx="48" strokeWidth="24" stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
  ...
  <circle cx="128" cy="127.99997" r="32"/>
  <path d="M172,28H84A56.06353,56.06353,0,0,0,28,84v88a56.06354,56.06354,0,0,0,56,56h88a56.06354,56.06354,0,0,0,56-56V84A56.06353,56.06353,0,0,0,172,28ZM128,176a48,48,0,1,1,48-48A48.05437,48.05437,0,0,1,128,176Zm52-88a12,12,0,1,1,12-12A12,12,0,0,1,180,88Z"/>

</>)
    case "light":
      return (<>
  <circle cx="128" cy="128" r="40" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  <rect x="36" y="36" width="184" height="184" rx="48" strokeWidth="12" stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
  ...
  <rect x="36" y="36" width="184" height="184" rx="48" strokeWidth="8" stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
...
const Instagram = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
